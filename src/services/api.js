...
//  * This component displays the loan history for users.
//  * It fetches data from the API and renders it in a table format.
//  * Additional features may include sorting and filtering.
